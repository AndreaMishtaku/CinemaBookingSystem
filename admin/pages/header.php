...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>Forumi i filmit</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="treeview">
          ...
          <li class="treeview">
          <a href="add_cinema.php">
            <i class="fa fa-film"></i> <span>Shto kinema</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="add_movie_news.php">
            <i class="fa fa-plus"></i> <span>Shto lajmerim</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="messages.php">
            <i class="fa fa-list-alt"></i> <span>Mesazhe</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
