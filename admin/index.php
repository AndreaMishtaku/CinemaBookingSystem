...
<div class="login-box">
  <div class="login-logo">
    <a><b> &nbsp; Hyrja si administrator</b></a>
  </div>
  <!-- /.login-logo -->
...
<form action="pages/process_login.php" method="post">
      ...
      <div class="form-group">
          <button type="submit" type ="submit" name="identifikohu" class="btn btn-danger">Identifikohu</button>
      </div>
    </form>

    <a href="../manager/index.php">Shko te hyrja per menaxher kinemaje</a>
